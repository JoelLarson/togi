Feature: Customizing principle pages
  As an operator curating my engineering standards
  I want to adapt principle pages without breaking their aliases
  So that my standards can change without findings losing their guidance
